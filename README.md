...
This project was originally forked from [rsky/php-mecab](https://github.com/rsky/php-mecab) with additional contributions pulled in from from [ranvis/php-mecab](https://github.com/ranvis/php-mecab).
